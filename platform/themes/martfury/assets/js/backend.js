        ...
        window.onChangeSwatchesSuccess = function (res, $attrs) {
            ...
            if (res) {
                ...
                if (res.error) {
                    ...
                    $form.find('.ps-product__price span').text(res.data.display_sale_price);
                    if (res.data.sale_price !== res.data.price) {
                        $form.find('.ps-product__price del').text(res.data.display_price).show();
                    } else {
                        $form.find('.ps-product__price del').hide();
                    }
