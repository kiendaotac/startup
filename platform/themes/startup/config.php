    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme) {
            ...
            $theme->asset()->usePath()->add('all', 'assets/css/all.css', [], [], $version);
            $theme->asset()->usePath()->add('bootstrap', 'assets/css/bootstrap.min.css');
            $theme->asset()->usePath()->add('animations', 'assets/css/animations.css');
            $theme->asset()->usePath()->add('fonts', 'assets/css/fonts.css');
            $theme->asset()->usePath()->add('main', 'assets/css/main.css');
            $theme->asset()->usePath()->add('default_style', 'assets/css/default_style.min.css');
            $theme->asset()->usePath()->add('custom', 'assets/css/custom.css');
            $theme->asset()->usePath()->add('shop', 'assets/css/shop.css');
            /*
            ...
            */
            $theme->asset()->container('footer')->usePath()->add('modernizr', 'assets/js/modernizr-2.6.2.min.js');
            $theme->asset()->container('footer')->usePath()->add('compressed', 'assets/js/compressed.js');
            $theme->asset()->container('footer')->usePath()->add('main', 'assets/js/main.js');
